...
if __name__ == "__main__":
    ...
    # Printing a random training example
    ...
    # Calling the advanced feature extractor
    features = mp.extract_advanced_features(ALL_TRAINING_IMAGES[example_number],
        DATA_WIDTH, DATA_HEIGHT)

    # Compute parameters for a Naive Bayes classifier using the advanced feature
    # extractor
    mp.compute_statistics_2(ALL_TRAINING_IMAGES, ALL_TRAINING_LABELS, DATA_WIDTH,
        DATA_HEIGHT, mp.extract_advanced_features)

    # Making predictions on validation data
    predicted_labels = mp.classify_2(ALL_VALIDATION_IMAGES, DATA_WIDTH, DATA_HEIGHT,
